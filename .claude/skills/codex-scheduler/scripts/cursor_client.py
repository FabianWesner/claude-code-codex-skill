...
# levels they offer (Grok 4.7 has low/medium/high/xhigh; Luna and Sol add none/max; Composer has
...
# offer `max`, Grok 4.7 stops at `xhigh`. Trying the chain in order means --effort max/ultra gets
